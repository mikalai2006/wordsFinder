...
public class Lighting : BaseEntity
{
  ...
  public override void Collect()
  {
    ...
    Vector3 positionTo = _levelManager.ManagerHiddenWords.tilemap.WorldToCell(_levelManager.buttonLighting.transform.position);
    RunMoveEffect();
    ...
    transform
      ...
      .OnComplete(() =>
      {
        _stateManager.UseHint(1, TypeEntity.Lighting);
